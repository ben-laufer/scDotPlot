...
```{r Plot SingleCellExperiment logcounts, fig.width=12, fig.height=12}
library(scDotPlot)
library(ggsci)
...
```{r Plot SingleCellExperiment Z, fig.width=12, fig.height=12}
sce |>
...
```{r Plot Seurat logcounts, fig.width=4, fig.height=5}
pbmc_small |>
    scDotPlot(features = features,
              group = "RNA_snn_res.1",
...
```{r Plot Seurat Z, fig.width=4, fig.height=5}
pbmc_small |>
    scDotPlot(scale = TRUE,
              features = features,
              group = "RNA_snn_res.1",
